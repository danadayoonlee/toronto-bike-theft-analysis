...
# From Occurrence_Date to get day of week
...
df_g9['Cost_of_Bike'].dtype
df_g9['Cost_of_Bike'].value_counts()

# Check after (2 method)
print(df_g9['Cost_of_Bike'].isnull().sum()) # Check after fill na will median
...
path ="C:/Users/User/Desktop/" # change to your local path
...
df_g9_division_safe5 =df_g9["Division"].value_counts().tail(5) 
...
# Plot-bar-Top5 Dangerous Division
import matplotlib.pyplot as plt
...
plt.xlabel('Division')
plt.ylabel('Stolen')
plt.title('Toronto Bike Theft (2014-2019) - Top5 Dangerous Division ')
plt.show()

# Plot-bar-Top5 Safe Division
import matplotlib.pyplot as plt
# x = df_g9_division_safe5.index #[33, 12, 23, 42, 58]
x= ['33', '12', '23', '42', '58']#[3913, 3845, 3572, 1748, 1614]
y = df_g9_division_safe5.values  
bar_Division = plt.bar(x,y, width=0.5, color ='green')
plt.xlabel('Division')
plt.ylabel('Stolen')
plt.title(' Toronto Bike Theft (2014-2019) - Top5 Safe Division')
plt.show()

# Neighbourhood
df_g9["Neighbourhood"].value_counts()  #140
df_g9_NeighbourhoodTop10 = df_g9["Neighbourhood"].value_counts().head(10) 
df_g9_NeighbourhoodTop10Safe = df_g9["Neighbourhood"].value_counts().tail(10) 
...
# Plot-bar-Top10 Dangerous Neighbourhood
import matplotlib.pyplot as plt
...
plt.xlabel('Neighbourhood')
plt.ylabel('Stolen')
plt.title(' Toronto Bike Theft (2014-2019) - Top10 Dangerous Neighbourhood')
plt.show()

# Plot-bar-Top10 Safe Neighbourhood
import matplotlib.pyplot as plt
x = df_g9_NeighbourhoodTop10Safe.index 
y = df_g9_NeighbourhoodTop10Safe.values  
bar_Division = plt.bar(x,y, width=0.5, color ='green')
plt.xticks(rotation=90)
plt.xlabel('Neighbourhood')
plt.ylabel('Stolen')
plt.title(' Toronto Bike Theft (2014-2019) - Top10 Safe Neighbourhood')
plt.show()

# Premise_Type
df_g9['Premise_Type'].value_counts()
...
# Location_Type
df_g9['Location_Type'].value_counts()
...
# Bike_Make
df_g9['Bike_Make'].value_counts()
df_g9_BikeMakeTop10 =df_g9['Bike_Make'].value_counts().head(10)
df_g9_BikeMakeTop10Safe = df_g9['Bike_Make'].value_counts().tail(10)
...
import matplotlib.pyplot as plt
x = df_g9_BikeMakeTop10Safe.index 
y = df_g9_BikeMakeTop10Safe.values  
bar_Bike_Make = plt.bar(x,y, width=0.5, color ='green')
plt.xticks(rotation=90)
plt.xlabel('Bike_Make')
plt.ylabel('Stolen')
plt.title('Toronto Bike Theft (2014-2019) - Safe Bike_Make and Stolen')

# Bike_Colour
df_g9['Bike_Colour'].value_counts()
df_g9_BikeColorTop10 = df_g9['Bike_Colour'].value_counts().head(10)
df_g9_BikeColorTop10Safe = df_g9['Bike_Colour'].value_counts().tail(10)
df_g9['Bike_Colour'].describe()
df_g9['Bike_Colour'].unique()

# Plot-bar-Top10 Dangerous Bike_Colour
import matplotlib.pyplot as plt
...
plt.ylabel('Stolen')
plt.title('Toronto Bike Theft (2014-2019) - Bike_Colour and Stolen')
plt.show()

# Plot-bar-Top10 Safe Bike_Colour
import matplotlib.pyplot as plt
x = df_g9_BikeColorTop10Safe.index 
y = df_g9_BikeColorTop10Safe.values  
bar_Bike_Make = plt.bar(x,y, width=0.5, color ='green')
plt.xticks(rotation=90)
plt.xlabel('Bike_Colour')
plt.ylabel('Stolen')
plt.title('Toronto Bike Theft (2014-2019)- Safe Bike_Colour and Stolen')
...
plt.xlabel('Year')
plt.ylabel('Stolen')
plt.title('Toronto Bike Theft (2014-2019) - Year and Stolen (From high to low)')
plt.show()
...
# Day Of Week
import matplotlib.pyplot as plt
df_g9_dayofweek = df_g9['dayofweek'].value_counts()
df_g9['dayofweek'].value_counts()
...
plt.xlabel('Day')
plt.ylabel('Stolen')
plt.title('Toronto Bike Theft (2014-2019)- Day of Week and Stolen (from high to low)')
plt.show()
...
df_g9['Primary_Offence'].value_counts()
